...
function reprEnum(e_p0, typ_p1) {
  ...
  framePtr = F;
    ...
    var tmp_33557560 = false;
    F.line = 31;
    var item_33557561 = typ_p1.node.sons[e_p0];
    F.line = 32;
    tmp_33557560 = item_33557561 !== undefined
    if (tmp_33557560) {
    F.line = 34;
    result_33557559 = nimCopy(null, makeNimstrLit(item_33557561.name), NTI33554449);
    }
    else {
      F.line = 36;
      result_33557559 = nimCopy(null, (HEX24__systemZdollars_u8(e_p0)).concat([32,40,105,110,118,97,108,105,100,32,100,97,116,97,33,41]), NTI33554449);
    }
    
  framePtr = F.prev;

  return result_33557559;
...
async function doFetch__jsfetch95examples9549_u170() {
...
async function example__jsfetch95examples9549_u202() {
  ...
  BeforeRet: {
    F.line = 119;
    F.filename = "jsfetch.nim";
    var response_654311638 = (await doFetch__jsfetch95examples9549_u170());
...
function catch__jsfetch95examples9549_u386(future_p0, onReject_p1) {
...
function then__jsfetch95examples9549_u360(future_p0, onSuccess_p1, onReject_p2) {
...
function then__jsfetch95examples9549_u319(future_p0, onSuccess_p1, onReject_p2) {
...
async function example2__jsfetch95examples9549_u270() {

function HEX3Aanonymous__jsfetch95examples9549_u300(response_p0) {
...
function HEX3Aanonymous__jsfetch95examples9549_u357(json_p0) {
  var F = {procname: "example2.:anonymous", prev: framePtr, filename: "/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim", line: 0};
  framePtr = F;
    F.line = 88;
    F.filename = "jsfetch_examples_1.nim";
...
function HEX3Aanonymous__jsfetch95examples9549_u383(err_p0) {
  var F = {procname: "example2.:anonymous", prev: framePtr, filename: "/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim", line: 0};
  framePtr = F;
    F.line = 119;
    F.filename = "jsfetch.nim";
  ...
  BeforeRet: {
    F.line = 119;
    F.filename = "jsfetch.nim";
    Temporary1 = HEX3Aanonymous__jsfetch95examples9549_u383.bind(null); Temporary1.ClP_0 = HEX3Aanonymous__jsfetch95examples9549_u383; Temporary1.ClE_0 = null;
    (await catch__jsfetch95examples9549_u386(then__jsfetch95examples9549_u360(then__jsfetch95examples9549_u319(fetch("https://api.github.com/users/torvalds"), HEX3Aanonymous__jsfetch95examples9549_u300, null), HEX3Aanonymous__jsfetch95examples9549_u357, null), Temporary1));
    F.line = 119;
...
Label4: {
  F.line = 119;
  (example__jsfetch95examples9549_u202());
};
Label5: {
  F.line = 119;
  (example2__jsfetch95examples9549_u270());
};
}

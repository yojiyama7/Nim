...
function HEX3DHEX3D__jsheaders95examples9549_u13(x_p0, y_p1) {
...
function HEX3DHEX3D__jsheaders95examples9549_u99(x_p0, y_p1) {
...
function HEX3DHEX3D__jsheaders95examples9549_u72(x_p0, y_p1) {
      ...
      Label2: {
        F.line = 97;
          ...
          if (!(res_654311696 <= colontmp__654311695)) break Label3;
            ...
            if (!(HEX3DHEX3D__jsheaders95examples9549_u99(x_p0[chckIndx(i_654311522, 0, (x_p0).length - 1)], y_p1[chckIndx(i_654311522, 0, (y_p1).length - 1)]))) {
            F.line = 335;
            result_654311500 = false;
            break BeforeRet;
            }
...
Label1: {
  ...
  if (!(HEX3DHEX3D__jsheaders95examples9549_u13(Array.from(header_654311427.keys()), ["key"]))) {
  F.line = 51;
  ...
  if (!(HEX3DHEX3D__jsheaders95examples9549_u13(Array.from(header_654311427.values()), ["value"]))) {
  F.line = 51;
  ...
  if (!(HEX3DHEX3D__jsheaders95examples9549_u72(Array.from(header_654311427.entries()), [nimCopy(null, {Field0: "key", Field1: "value"}, NTI654311479), nimCopy(null, {Field0: "other", Field1: "another"}, NTI654311479)]))) {
  F.line = 51;
  ...
  if (!(HEX3DHEX3D__jsheaders95examples9549_u72(Array.from(header_654311427.entries()), [nimCopy(null, {Field0: "key", Field1: "value"}, NTI654311511)]))) {
  F.line = 51;
  ...
  if (!(HEX3DHEX3D__jsheaders95examples9549_u72(Array.from(header_654311427.entries()), []))) {
  F.line = 51;
